...
;layui.define(["layer", "form"], function (t) {
    ...
    var e = layui.$, i = layui.layer, a = layui.form, l = (layui.hint(), layui.device()), n = "layedit",
        o = "layui-show", r = "layui-disabled", c = function () {
            var t = this;
            t.index = 0, t.config = {
                tool: ["strong", "italic", "underline", "del", "color", "|", "left", "center", "right", "|", "link", "unlink", "face", "image", "video"],
                hideTool: [],
                height: 280
            }
        };
    ...
    var s = function (t, i, a) {
        ...
        var n = t.document, o = e(n.body), c = {
            link: function (i) {
                ...
                layer.msg("温馨提示：插入视频前，请先在前后添加换行");
                ...
                var a = p(i), l = e(a).parent();
                z.call(o, {href: l.attr("size"), color: l.attr("color")}, function (e) {
                    var a = l[0];
                    "A" === a.tagName ? a.href = e.url : v.call(t, "font", {
                        color: e.color,
                        size: e.url,
                        text: e.url
                    }, i)
        ...
        var l = this, n = i.open({
            ...
            title: "设置字体",
            skin: "layui-layer-msg",
            content: ['<ul class="layui-form" style="margin: 15px;">', '<li class="layui-form-item">', '<label class="layui-form-label" style="width: 60px;">字体大小</label>', '<div class="layui-input-block" style="margin-left: 90px">', '<input name="url" value="' + (t.href || "") + '" autofocus="true" autocomplete="off" class="layui-input" placeholder="范围（1-7）">', "</div>", "</li>", '<li class="layui-form-item">', '<label class="layui-form-label" style="width: 60px;">字体颜色</label>', '<div class="layui-input-block" style="margin-left: 90px">', '<input type="radio" name="color" value="black" class="layui-input" title="黑"' + ("_self" !== t.target && t.target ? "" : "checked") + ">", '<input type="radio" name="color" value="blue" class="layui-input" title="蓝" ' + ("_blank" === t.target ? "checked" : "") + ">", '<input type="radio" name="color" value="yellow" class="layui-input" title="黄" ' + ("_blank" === t.target ? "checked" : "") + ">", '<input type="radio" name="color" value="green" class="layui-input" title="绿" ' + ("_blank" === t.target ? "checked" : "") + ">", '<input type="radio" name="color" value="purple" class="layui-input" title="紫" ' + ("_blank" === t.target ? "checked" : "") + ">", '<input type="radio" name="color" value="red" class="layui-input" title="红" ' + ("_blank" === t.target ? "checked" : "") + ">", "</div>", "</li>", '<li class="layui-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-filter="layedit-link-yes" class="layui-btn"> 确定 </button>', '<button style="margin-left: 20px;" type="button" class="layui-btn layui-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
            success: function (t, n) {
                var o = "submit(layedit-link-yes)";
                a.render("radio"), t.find(".layui-btn-primary").on("click", function () {
                    i.close(n), l.focus()
                }), a.on(o, function (t) {
                    i.close(z.index), e && e(t.field)
                })
            }
        });
        z.index = n
        ...
        color: '<i class="layui-icon layedit-tool-color" title="字体效果" layedit-event="color">&#xe66a;</i>',
    }, w = new c;
    t(n, w)
});